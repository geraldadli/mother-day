...
const Card: React.FC = () => {
  ...
  const handleDownload = () => {
    // In a real app, this would generate a downloadable version of the card
  ...
  useEffect(() => {
    ...
    const audioManager = AudioManager.getInstance();
    // Nothing needed here - just ensuring the singleton is instantiated
    return () => {
  ...
  return (
    <>
      ...
      <div className="relative w-full max-w-4xl mx-auto flex flex-col items-center">
        ...
        <motion.div 
          className="relative w-full max-w-2xl perspective"
        ...
        >
          ...
          >
            <div 
              className="card-container relative transition-transform duration-1000 ease-in-out transform-style w-full h-[600px] sm:h-[700px]"
              style={{ 
